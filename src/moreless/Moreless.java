...
public class Moreless {
    ...
    private static void measureDummyBot(){
        ...
        System.out.println("Dummy bot statistic: + (sum/1000)");
    }
    ...
    private static void startGame(Scanner scanner) {
        ...
        System.out.println("Game is finshed! Result: "+ counter);
    }
    ...
    private static int generateGameNumber(){
        ...
        return radom.nextInt( 10);
    }
    private static void showRules(Scanner scanner) {
        System.out.println("Tutaj beda wyswietlane zasady gry");
